class HistoricalViewer {
    ...
    applyModeSliderShape() {
        ...
        if (container) {
            container.classList.toggle('present32', this.isPresent());
        }
    ...
    loadVideos() {
        ...
        const mega_sam_path = `${this.assets_path}/${this.prefix}/megasam/${scene}/pastfuture/Ours.mp4`;
        const mega_sam_poses_path = `${this.assets_path}/${this.prefix}/megasam_poses/${scene}/pastfuture/Ours.mp4`;
